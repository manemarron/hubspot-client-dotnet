//-----------------------------------------------------------------------
// <copyright file="ContactDoesNotExistResponse.cs" company="Jose Manuel Marron Ruiz">
...
namespace HubspotClientDotnet.HttpClient.V3.Contacts.Models
{
    ...
    /// </summary>
    public class ContactDoesNotExistResponse : BaseContactResponse
    {
        /// <summary>Gets the response type.</summary>
        public override ContactResponseType ResponseType => ContactResponseType.ContactDoesNotExist;
    }
}